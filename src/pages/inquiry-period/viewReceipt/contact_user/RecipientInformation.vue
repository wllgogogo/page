        ...
        <div class="card">
            <Row>
                ...
                <Col span="6">
                    ...
                    <Input v-else v-model="senderFormItem.attenName" disabled></Input>
                ...
                <Col span="6">
                    ...
                    <Input v-else v-model="takerFormItem.attenName" disabled></Input>
                ...
                <Col span="6">
                    ...
                    <Input v-else v-model="notifierFormItem.attenName" disabled></Input>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            if (allValid) {
                ...
                const data = [this.senderFormItem, this.takerFormItem, this.notifierFormItem]
        ...
        submitPopForm() {
            this.$refs.popFormItemData.validate(valid => {
                if (valid) {
                    ...
                    const addObj = JSON.parse(JSON.stringify(this.popFormItem))
                    // 要发送请求保存信息,后端判断是否重复
                    // 如果不重复
                    if (this.addType === 1) {
    ...
    watch: {
        defaultData: {
            handler(val, oldVal) {
                if (val.length >= 1) {
                    const tel1 = val[0].attenTel
                    const tel2 = val[1].attenTel
                    const tel3 = val[2].attenTel
